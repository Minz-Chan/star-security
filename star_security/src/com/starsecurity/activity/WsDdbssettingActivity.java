 ...
 *
 */
//public class WsDdbssettingActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
public class WsDdbssettingActivity extends Activity{
...
//	private EditTextPreference ddns_devicename;
	...
	private EditText ddns_server;
	private EditText ddns_port;
	private EditText user_id;
	private EditText ddns_password;
	private EditText ddns_devicename;
...
//            addPreferencesFromResource(R.xml.ddbssetting);
            setContentView(R.xml.ws_ddbssettings);
...
//            ddns_devicename = (EditTextPreference) findPreference("device_name");
         	...
         	ddns_server = (EditText) findViewById(R.id.ddns_server);
         	ddns_port = (EditText) findViewById(R.id.ddns_port);
         	user_id = (EditText) findViewById(R.id.ddns_userid);
         	ddns_password = (EditText) findViewById(R.id.ddns_password);
         	ddns_devicename = (EditText) findViewById(R.id.ddns_devicename);
...
//    }  
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.ddns_requestMenu:
			...
			intent.setClass(WsDdbssettingActivity.this, DeviceListActivity.class);
			if(ddns_server.getText()!=null){
		...
		case R.id.ddns_backMenu:
			WsDdbssettingActivity.this.finish();
			break;
		}
		return true;
	}
